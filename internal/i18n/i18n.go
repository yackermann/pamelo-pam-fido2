...
var catalogs = map[string]map[MessageID]string{
	"en": {
		...
		MsgConfigLoadFailed:            "fido2-pam-go: failed to load config %s: %v",
	...
	"es": {
		...
		MsgConfigLoadFailed:            "fido2-pam-go: no se pudo cargar la configuracion %s: %v",
	...
	"fr": {
		...
		MsgConfigLoadFailed:            "fido2-pam-go: echec du chargement de la configuration %s: %v",
	...
	"de": {
		...
		MsgConfigLoadFailed:            "fido2-pam-go: Konfiguration %s konnte nicht geladen werden: %v",
	...
	"ja": {
		...
		MsgConfigLoadFailed:            "fido2-pam-go: 設定 %s の読み込みに失敗しました: %v",
	...
	"zh": {
		...
		MsgConfigLoadFailed:            "fido2-pam-go: 加载配置 %s 失败: %v",
